...
class PrepareIndexTests(unittest.TestCase):
    def test_fonts_are_hashed_urls_not_base64(self) -> None:
        ...
        self.assertIn("cache.js?v=1.3.23", html)
        self.assertIn("function pullServerHistory", html)
        self.assertIn("/rc-history?tab=", html)
        self.assertIn("__rcBootHistory", html)
        self.assertIn("__rcPendingHistory", html)
        cache = (svc.assets_dir / "cache.js").read_text(encoding="utf-8")
        self.assertIn("payload.all", cache)
        self.assertIn("function pullHistory", cache)
        self.assertIn("__rcPendingHistory", cache)
        ...
        self.assertIn("__rcPaintHistory", html)
        self.assertIn("function mountHistory", html)
        self.assertIn("function syncHistoryFromTerm", html)
        ...
        self.assertNotIn("/rc-scroll", html)
